...
El gráfico de Asignación Sectorial ratifica la identidad del $QQQ$ no como un índice de mercado amplio, sino como un vehículo de inversión temático con un sesgo factorial explícito: el sector $ecnología$ ejerce una hegemonía absoluta sobre la estructura del fondo, acaparando el 53.9% de los activos netos. Esta concentración masiva desborda los límites tradicionales de la diversificación sectorial, convirtiendo al ETF en un instrumento altamente sensible a los ciclos de innovación y a las revisiones de valoración específicas de la industria tecnológica.
...
Bollerslev, T. (1986). Heteroscedasticidad condicional autorregresiva generalizada. Journal of Econometrics, 31(3), 307–327. [https://doi.org/10.1016/0304-4076(86)90063-1](https://doi.org/10.1016/0304-4076(86)90063-1){.uri}
