...
```{r tortA, echo=FALSE, warning=FALSE, message=FALSE}
library(plotly)
sectores <- data.frame(
...
```{r tablarendimientos, echo=FALSE, warning=FALSE, message=FALSE}
library(quantmod)
library(dplyr)
library(ggplot2)
library(tidyverse)
...
```{r tablaretrnosentos, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r boxpllot, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r rendimientosaño, echo=TRUE, eval=TRUE}
library(dplyr)
library(ggplot2)
library(lubridate)
ret_anual_df <- data.frame(
...
```{r drawdown, echo=TRUE, eval=TRUE}
...
```{r metrics_financieras, echo=FALSE}
library(PerformanceAnalytics)
library(xts)
...
```{r heatmap_estacional_mejor, echo=FALSE}
library(ggplot2)
library(viridis)
...
```{r resumen_anual_tabla, echo=FALSE}
library(dplyr)
library(tidyr)
...
# Max drawdown por año (aprox: max drawdown dentro del año)
