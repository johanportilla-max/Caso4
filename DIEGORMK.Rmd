...
# Crear un frame por cada fila (por cada día)
datos_qqq$Frame <- as.character(datos_qqq$Fecha)

p <- ggplot(datos_qqq, aes(x = Fecha, y = Precio)) +
  geom_area(aes(frame = Frame), fill = tesla_pal$primary, alpha = 0.1) +
...
plotly::ggplotly(p, tooltip = c("x", "y")) %>%
  ...
  plotly::animation_slider(currentvalue = list(prefix = "Fecha: ")) %>%
