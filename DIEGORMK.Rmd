...
library(knitr)
library(dplyr)
serie_vec <- as.numeric(as.character(serie))
serie_vec <- serie_vec[!is.na(serie_vec)]
if (max(serie_vec) > 10000) {
  warning("⚠️ La serie contiene valores extremadamente altos. Revisa si es realmente precio de QQQ.")
}
